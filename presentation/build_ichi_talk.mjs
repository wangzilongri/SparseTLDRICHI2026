...
// Slide 2
{
  ...
  addTalkHeader(slide, "Clinical trial evidence rarely lands in the target population", "0:30-1:45", 37);
...
// Slide 6
{
  ...
  addTalkHeader(slide, "Two target regimes, two interpretations", "6:00-7:15");
...
// Slide 12
{
  ...
  timePill(slide, "13:45-15:00", 322, 626);
}
